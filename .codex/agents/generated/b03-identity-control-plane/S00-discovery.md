---
prompt_name: b03-identity-control-plane-s00-discovery
scope: Discovery for Identity and Control Plane; no execution while this outline remains disabled.
...
validation_strategy:
  ...
  evidence_target: docs/architecture/workstreams/b03-identity-control-plane-stage-reports/S00-discovery.md
  tests_only_allowed_reason: null
proof_boundary:
  label: b03-identity-control-plane-s00-discovery
  exclusions:
...
When separately activated and detailed, complete `S00 — Discovery` for `B03 Identity and Control Plane`: Confirm source-anchored scope, ownership, vocabulary, dependencies, risks, and stop gates.
...
- Evidence target: `docs/architecture/workstreams/b03-identity-control-plane-stage-reports/S00-discovery.md`.
