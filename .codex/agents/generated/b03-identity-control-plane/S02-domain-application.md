---
prompt_name: b03-identity-control-plane-s02-domain-application
scope: Domain and application for Identity and Control Plane; no execution while this outline remains disabled.
...
validation_strategy:
  ...
  evidence_target: docs/architecture/workstreams/b03-identity-control-plane-stage-reports/S02-domain-application.md
  tests_only_allowed_reason: null
proof_boundary:
  label: b03-identity-control-plane-s02-domain-application
  exclusions:
...
When separately activated and detailed, complete `S02 — Domain and application` for `B03 Identity and Control Plane`: Implement or specify framework-free aggregates, invariants, policies, use cases, and owned ports.
...
- Evidence target: `docs/architecture/workstreams/b03-identity-control-plane-stage-reports/S02-domain-application.md`.
