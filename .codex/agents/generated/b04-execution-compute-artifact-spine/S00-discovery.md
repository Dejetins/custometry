---
prompt_name: b04-execution-compute-artifact-spine-s00-discovery
scope: Discovery for Execution, Compute and Artifact Spine; no execution while this outline remains disabled.
...
validation_strategy:
  ...
  evidence_target: docs/architecture/workstreams/b04-execution-compute-artifact-spine-stage-reports/S00-discovery.md
  tests_only_allowed_reason: null
proof_boundary:
  label: b04-execution-compute-artifact-spine-s00-discovery
  exclusions:
...
When separately activated and detailed, complete `S00 — Discovery` for `B04 Execution, Compute and Artifact Spine`: Confirm source-anchored scope, ownership, vocabulary, dependencies, risks, and stop gates.
...
- Evidence target: `docs/architecture/workstreams/b04-execution-compute-artifact-spine-stage-reports/S00-discovery.md`.
