---
prompt_name: b04-execution-compute-artifact-spine-s01-ux-contract
scope: UX and contract for Execution, Compute and Artifact Spine; no execution while this outline remains disabled.
...
validation_strategy:
  ...
  evidence_target: docs/architecture/workstreams/b04-execution-compute-artifact-spine-stage-reports/S01-ux-contract.md
  tests_only_allowed_reason: null
proof_boundary:
  label: b04-execution-compute-artifact-spine-s01-ux-contract
  exclusions:
...
When separately activated and detailed, complete `S01 — UX and contract` for `B04 Execution, Compute and Artifact Spine`: Freeze routes, states, commands, queries, events, schemas, permissions, errors, and compatibility.
...
- Planned depth: `api`.
- Evidence target: `docs/architecture/workstreams/b04-execution-compute-artifact-spine-stage-reports/S01-ux-contract.md`.
