---
prompt_name: b04-execution-compute-artifact-spine-s02-domain-application
scope: Domain and application for Execution, Compute and Artifact Spine; no execution while this outline remains disabled.
...
validation_strategy:
  ...
  evidence_target: docs/architecture/workstreams/b04-execution-compute-artifact-spine-stage-reports/S02-domain-application.md
  tests_only_allowed_reason: null
proof_boundary:
  label: b04-execution-compute-artifact-spine-s02-domain-application
  exclusions:
...
When separately activated and detailed, complete `S02 — Domain and application` for `B04 Execution, Compute and Artifact Spine`: Implement or specify framework-free aggregates, invariants, policies, use cases, and owned ports.
...
- Evidence target: `docs/architecture/workstreams/b04-execution-compute-artifact-spine-stage-reports/S02-domain-application.md`.
