---
prompt_name: b04-execution-compute-artifact-spine-s03-adapters
scope: Adapters for Execution, Compute and Artifact Spine; no execution while this outline remains disabled.
...
validation_strategy:
  ...
  evidence_target: docs/architecture/workstreams/b04-execution-compute-artifact-spine-stage-reports/S03-adapters.md
  tests_only_allowed_reason: null
proof_boundary:
  label: b04-execution-compute-artifact-spine-s03-adapters
  exclusions:
...
When separately activated and detailed, complete `S03 — Adapters` for `B04 Execution, Compute and Artifact Spine`: Implement or specify persistence and outbound adapters, migrations, retry classes, and unknown-state reconciliation.
...
- Evidence target: `docs/architecture/workstreams/b04-execution-compute-artifact-spine-stage-reports/S03-adapters.md`.
