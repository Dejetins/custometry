---
prompt_name: b04-execution-compute-artifact-spine-s05-real-boundary-proof
scope: Real-boundary proof for Execution, Compute and Artifact Spine; no execution while this outline remains disabled.
...
validation_strategy:
  ...
  evidence_target: docs/architecture/workstreams/b04-execution-compute-artifact-spine-stage-reports/S05-real-boundary-proof.md
  tests_only_allowed_reason: null
proof_boundary:
  label: b04-execution-compute-artifact-spine-s05-real-boundary-proof
  exclusions:
...
When separately activated and detailed, complete `S05 — Real-boundary proof` for `B04 Execution, Compute and Artifact Spine`: Observe the nearest database, API, browser, worker, Compose, or artifact boundary required by the slice.
...
- Evidence target: `docs/architecture/workstreams/b04-execution-compute-artifact-spine-stage-reports/S05-real-boundary-proof.md`.
