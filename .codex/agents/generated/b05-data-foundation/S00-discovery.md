---
prompt_name: b05-data-foundation-s00-discovery
scope: Discovery for Data Foundation; no execution while this outline remains disabled.
...
validation_strategy:
  ...
  evidence_target: docs/architecture/workstreams/b05-data-foundation-stage-reports/S00-discovery.md
  tests_only_allowed_reason: null
proof_boundary:
  label: b05-data-foundation-s00-discovery
  exclusions:
...
When separately activated and detailed, complete `S00 — Discovery` for `B05 Data Foundation`: Confirm source-anchored scope, ownership, vocabulary, dependencies, risks, and stop gates.
...
- Evidence target: `docs/architecture/workstreams/b05-data-foundation-stage-reports/S00-discovery.md`.
