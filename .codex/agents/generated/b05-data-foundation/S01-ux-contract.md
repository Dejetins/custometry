---
prompt_name: b05-data-foundation-s01-ux-contract
scope: UX and contract for Data Foundation; no execution while this outline remains disabled.
...
validation_strategy:
  ...
  evidence_target: docs/architecture/workstreams/b05-data-foundation-stage-reports/S01-ux-contract.md
  tests_only_allowed_reason: null
proof_boundary:
  label: b05-data-foundation-s01-ux-contract
  exclusions:
...
When separately activated and detailed, complete `S01 — UX and contract` for `B05 Data Foundation`: Freeze routes, states, commands, queries, events, schemas, permissions, errors, and compatibility.
...
- Planned depth: `api`.
- Evidence target: `docs/architecture/workstreams/b05-data-foundation-stage-reports/S01-ux-contract.md`.
