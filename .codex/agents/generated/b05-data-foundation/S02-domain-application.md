---
prompt_name: b05-data-foundation-s02-domain-application
scope: Domain and application for Data Foundation; no execution while this outline remains disabled.
...
validation_strategy:
  ...
  evidence_target: docs/architecture/workstreams/b05-data-foundation-stage-reports/S02-domain-application.md
  tests_only_allowed_reason: null
proof_boundary:
  label: b05-data-foundation-s02-domain-application
  exclusions:
...
When separately activated and detailed, complete `S02 — Domain and application` for `B05 Data Foundation`: Implement or specify framework-free aggregates, invariants, policies, use cases, and owned ports.
...
- Evidence target: `docs/architecture/workstreams/b05-data-foundation-stage-reports/S02-domain-application.md`.
