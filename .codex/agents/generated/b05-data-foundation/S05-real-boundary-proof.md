---
prompt_name: b05-data-foundation-s05-real-boundary-proof
scope: Real-boundary proof for Data Foundation; no execution while this outline remains disabled.
...
validation_strategy:
  ...
  evidence_target: docs/architecture/workstreams/b05-data-foundation-stage-reports/S05-real-boundary-proof.md
  tests_only_allowed_reason: null
proof_boundary:
  label: b05-data-foundation-s05-real-boundary-proof
  exclusions:
...
When separately activated and detailed, complete `S05 — Real-boundary proof` for `B05 Data Foundation`: Observe the nearest database, API, browser, worker, Compose, or artifact boundary required by the slice.
...
- Evidence target: `docs/architecture/workstreams/b05-data-foundation-stage-reports/S05-real-boundary-proof.md`.
