---
prompt_name: b06-analytics-forecasting-vertical-alpha-s00-discovery
scope: Discovery for Analytics and Forecasting Vertical Alpha; no execution while this outline remains disabled.
...
validation_strategy:
  ...
  evidence_target: docs/architecture/workstreams/b06-analytics-forecasting-vertical-alpha-stage-reports/S00-discovery.md
  tests_only_allowed_reason: null
proof_boundary:
  label: b06-analytics-forecasting-vertical-alpha-s00-discovery
  exclusions:
...
When separately activated and detailed, complete `S00 — Discovery` for `B06 Analytics and Forecasting Vertical Alpha`: Confirm source-anchored scope, ownership, vocabulary, dependencies, risks, and stop gates.
...
- Evidence target: `docs/architecture/workstreams/b06-analytics-forecasting-vertical-alpha-stage-reports/S00-discovery.md`.
