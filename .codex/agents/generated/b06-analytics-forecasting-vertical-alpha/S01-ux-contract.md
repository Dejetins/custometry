---
prompt_name: b06-analytics-forecasting-vertical-alpha-s01-ux-contract
scope: UX and contract for Analytics and Forecasting Vertical Alpha; no execution while this outline remains disabled.
...
- skill: contract-impact-analysis
  role: primary
  use_when: executing the authorized S01 ux and contract stage
...
validation_strategy:
  ...
  evidence_target: docs/architecture/workstreams/b06-analytics-forecasting-vertical-alpha-stage-reports/S01-ux-contract.md
  tests_only_allowed_reason: null
proof_boundary:
  label: b06-analytics-forecasting-vertical-alpha-s01-ux-contract
  exclusions:
...
When separately activated and detailed, complete `S01 — UX and contract` for `B06 Analytics and Forecasting Vertical Alpha`: Freeze routes, states, commands, queries, events, schemas, permissions, errors, and compatibility.
...
- Freeze routes, states, commands, queries, events, schemas, permissions, errors, and compatibility.
...
3. Implement the smallest complete `S01` outcome.
...
- Planned depth: `api`.
- Evidence target: `docs/architecture/workstreams/b06-analytics-forecasting-vertical-alpha-stage-reports/S01-ux-contract.md`.
...
- [ ] The authorized `S01` outcome is observable and every listed requirement has traceable evidence.
