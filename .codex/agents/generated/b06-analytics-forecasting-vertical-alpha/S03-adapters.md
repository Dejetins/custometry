---
prompt_name: b06-analytics-forecasting-vertical-alpha-s03-adapters
scope: Adapters for Analytics and Forecasting Vertical Alpha; no execution while this outline remains disabled.
...
validation_strategy:
  ...
  evidence_target: docs/architecture/workstreams/b06-analytics-forecasting-vertical-alpha-stage-reports/S03-adapters.md
  tests_only_allowed_reason: null
proof_boundary:
  label: b06-analytics-forecasting-vertical-alpha-s03-adapters
  exclusions:
...
When separately activated and detailed, complete `S03 — Adapters` for `B06 Analytics and Forecasting Vertical Alpha`: Implement or specify persistence and outbound adapters, migrations, retry classes, and unknown-state reconciliation.
...
- Evidence target: `docs/architecture/workstreams/b06-analytics-forecasting-vertical-alpha-stage-reports/S03-adapters.md`.
