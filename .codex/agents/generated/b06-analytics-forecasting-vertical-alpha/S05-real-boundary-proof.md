---
prompt_name: b06-analytics-forecasting-vertical-alpha-s05-real-boundary-proof
scope: Real-boundary proof for Analytics and Forecasting Vertical Alpha; no execution while this outline remains disabled.
...
- skill: backend-quality-gates
  role: primary
  use_when: executing the authorized S05 real-boundary proof stage
...
validation_strategy:
  ...
  evidence_target: docs/architecture/workstreams/b06-analytics-forecasting-vertical-alpha-stage-reports/S05-real-boundary-proof.md
  tests_only_allowed_reason: null
proof_boundary:
  label: b06-analytics-forecasting-vertical-alpha-s05-real-boundary-proof
  exclusions:
...
When separately activated and detailed, complete `S05 — Real-boundary proof` for `B06 Analytics and Forecasting Vertical Alpha`: Observe the nearest database, API, browser, worker, Compose, or artifact boundary required by the slice.
...
- Observe the nearest database, API, browser, worker, Compose, or artifact boundary required by the slice.
...
3. Implement the smallest complete `S05` outcome.
...
- Planned depth: `runtime`.
- Evidence target: `docs/architecture/workstreams/b06-analytics-forecasting-vertical-alpha-stage-reports/S05-real-boundary-proof.md`.
...
- [ ] The authorized `S05` outcome is observable and every listed requirement has traceable evidence.
