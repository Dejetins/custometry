---
prompt_name: b07-operations-s02-domain-application
scope: Domain and application for Operations; no execution while this outline remains disabled.
...
validation_strategy:
  ...
  evidence_target: docs/architecture/workstreams/b07-operations-stage-reports/S02-domain-application.md
  tests_only_allowed_reason: null
proof_boundary:
  label: b07-operations-s02-domain-application
  exclusions:
...
When separately activated and detailed, complete `S02 — Domain and application` for `B07 Operations`: Implement or specify framework-free aggregates, invariants, policies, use cases, and owned ports.
...
- Evidence target: `docs/architecture/workstreams/b07-operations-stage-reports/S02-domain-application.md`.
