---
prompt_name: b07-operations-s03-adapters
scope: Adapters for Operations; no execution while this outline remains disabled.
...
validation_strategy:
  ...
  evidence_target: docs/architecture/workstreams/b07-operations-stage-reports/S03-adapters.md
  tests_only_allowed_reason: null
proof_boundary:
  label: b07-operations-s03-adapters
  exclusions:
...
When separately activated and detailed, complete `S03 — Adapters` for `B07 Operations`: Implement or specify persistence and outbound adapters, migrations, retry classes, and unknown-state reconciliation.
...
- Evidence target: `docs/architecture/workstreams/b07-operations-stage-reports/S03-adapters.md`.
