---
prompt_name: b07-operations-s04-web-integration
scope: Web integration for Operations; no execution while this outline remains disabled.
...
validation_strategy:
  ...
  evidence_target: docs/architecture/workstreams/b07-operations-stage-reports/S04-web-integration.md
  tests_only_allowed_reason: null
proof_boundary:
  label: b07-operations-s04-web-integration
  exclusions:
...
When separately activated and detailed, complete `S04 — Web integration` for `B07 Operations`: Connect the accepted contract to the Frost Web experience with complete system states and accessibility.
...
- Evidence target: `docs/architecture/workstreams/b07-operations-stage-reports/S04-web-integration.md`.
