---
prompt_name: b07-operations-s06-acceptance
scope: Acceptance for Operations; no execution while this outline remains disabled.
...
validation_strategy:
  ...
  evidence_target: docs/architecture/workstreams/b07-operations-stage-reports/S06-acceptance.md
  tests_only_allowed_reason: null
proof_boundary:
  label: b07-operations-s06-acceptance
  exclusions:
...
When separately activated and detailed, complete `S06 — Acceptance` for `B07 Operations`: Reconcile requirement evidence, contracts, docs, rollback, residual risk, and independent review.
...
- Evidence target: `docs/architecture/workstreams/b07-operations-stage-reports/S06-acceptance.md`.
