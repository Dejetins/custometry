...
stage_instance_id: G0@CUSTOMETRY-UI-DESIGN-PROGRAM-V2-r3
gate_id: G0
...
Execute only `G0@CUSTOMETRY-UI-DESIGN-PROGRAM-V2-r3` after bounded ledger context and an atomic claim. Use the current active contract, preserve historical evidence and foreign changes, satisfy the exact gate and adjacent-stage preflight, then durably update the sole stage ledger. Do not claim another row across an owner checkpoint.
