...
stage_instance_id: G5@wave.g5.01-r2
gate_id: G5
target_id: wave.g5.01-r2
...
current_stage: G5@wave.g5.01-r2
...
context:
  ...
  task_entrypoints: [.codex/delivery/ui-design-programs/custometry-v2/ui-design-program.json, .codex/delivery/ui-design-programs/custometry-v2/artifacts/g2-r2/waves/wave.g5.01.json]
...
validation_strategy:
  proof_boundary: finished wave review board with exact screen coverage, canonical browser evidence, responsive-Web proof, and accessibility smoke; no production implementation, deployment, performance, or full WCAG conformance proof
  evidence_target: .codex/delivery/evidence/custometry-ui-design-program-v2/g5-r2/wave-g5-01-wave-report.md
...
Execute only `G5@wave.g5.01-r2` when the ledger independently selects and claims it. Complete one bounded wave review unit from the accepted G2 structure and G3 foundations.
