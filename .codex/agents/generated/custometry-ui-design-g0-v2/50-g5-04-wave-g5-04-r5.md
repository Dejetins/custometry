...
stage_instance_id: G5@wave.g5.04-r5
gate_id: G5
target_id: wave.g5.04-r5
...
current_stage: G5@wave.g5.04-r5
...
Execute only `G5@wave.g5.04-r5` after bounded ledger context and an atomic claim. Use the current active contract, preserve historical evidence and foreign changes, satisfy the exact gate and adjacent-stage preflight, then durably update the sole stage ledger. Do not claim another row across an owner checkpoint.
