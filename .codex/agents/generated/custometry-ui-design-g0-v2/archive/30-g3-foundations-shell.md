...
stage_instance_id: G3@CUSTOMETRY-UI-DESIGN-PROGRAM-V2-r1
gate_id: G3
...
current_stage: G3@CUSTOMETRY-UI-DESIGN-PROGRAM-V2-r1
rendered_review_target: .codex/delivery/ui-design-programs/custometry-v2/evidence/g3/review-board.html
...
context:
  ...
  task_entrypoints: [.codex/delivery/ui-design-programs/custometry-v2/platform-ui-baseline.json, .codex/delivery/ui-design-programs/custometry-v2/ui-design-program.json]
  conditional_bundles: []
  consult_if_needed: []
skills:
...
validation_strategy:
  proof_boundary: finished foundations and shell review board with mode-correct browser, responsive, and accessibility-smoke evidence; no production deployment or full WCAG conformance proof
  evidence_target: .codex/delivery/evidence/custometry-ui-design-program-v2/g3-foundations-shell-report.md
  commands: [ui_program_context, program_ready, browser capture, validate_stage_ledger, assemble_stage_transition, validate_stage_transition]
file_manifest:
  expected_touch_zones: [.codex/delivery/ui-design-programs/custometry-v2/**, .codex/agents/generated/custometry-ui-design-g0-v2/**, .codex/delivery/evidence/custometry-ui-design-program-v2/**]
...
This row is a non-executable topology placeholder until an accepted, hash-pinned G2 transition synchronizes its incoming receipt and exact representative target. When later authorized and made claimable, execute only G3, produce the finished foundations/shell board and required browser evidence, then pause at owner review. Do not run during G0.
