...
| [Next milestone — MS-002](./planning/milestones/MS-002/plan.md) | C03 L3 accepted 1.0.0: guided installation, HTTPS, truthful readiness and a pilot-derived first-run entry; fixed implementation choices and owner decision packet; five prompts and one canonical journal; [S01 implementation evidence](../../.codex/delivery/evidence/MS-002/MS-002-S01/report.md), with later stage execution separate |
...
| [Audit contract proposals](./planning/audit-contract-decisions-2026-09-06.md) | Proposed PVM, shared cancellation and endpoint revocation; TLS-only Edge exception accepted through WS-001; runtime proof remains separate |
...
| [Runtime, network, and installation](./runtime-network-installation.md) | Persistent S01 installer and recovery contract (revision 21), download-first supply, ports, networks, resources and container lessons |
