...
name='custometry_ms003_s01_tests'
...
raise SystemExit(subprocess.run(['uv','run','--locked','pytest','-q','tests/integration/data_pipeline','tests/integration/identity_access'],env=env).returncode)
