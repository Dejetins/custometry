...
Title and source are in **Report settings** at the top right. Period, store and comparison open from the toolbar. **Save** is in the inspector footer and **Report view** (eye icon), together with exact preview. Change language through **Profile**.
