...
Возможности за пределами отдельно описанного рабочего пространства отчёта добавляются в своих продуктовых срезах.

[Вход и работа с отчётом о продажах](reports.md) описывает доступный срез отчётного рабочего пространства. Наличие в установленной сборке зависит от её версии.
