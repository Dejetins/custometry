...
blockers: []
supersession_reason: The product owner replaced the accepted HTML-first scaling path with a new pre-G0 product baseline covering common analytical documents, time-aware segments, digital journeys, product/category analytics, and a narrower pilot visual-language authority. This ticket is historical and must not execute.
context_sources:
  - AGENTS.md
  - .codex/AGENTS.md
