#!/usr/bin/env python3
"""Prepare deterministic owner-acceptance evidence and ledger candidates for G4 DASH r5."""
...
spec = importlib.util.spec_from_file_location("accept_g4_dash_base", SOURCE)
...
base.ARTIFACT = HERE / "artifacts/g4-r5/family-dash-shell-workspace-baseline"
base.EVIDENCE = HERE / "evidence/family.dash.shell-workspace.baseline-r5"
base.PREFLIGHT = base.EVIDENCE / "preflight"
base.REPORT = base.ROOT / ".codex/delivery/evidence/custometry-ui-design-program-v2/family.dash.shell-workspace.baseline-r5-report.md"
base.STAGE = "G4@family.dash.shell-workspace.baseline-r5"
base.NEXT_STAGE = "G4@family.rpt.shell-workspace.baseline-r5"
base.NEXT_PROMPT = base.ROOT / ".codex/agents/generated/custometry-ui-design-g0-v2/40-g4-11-family-rpt-shell-workspace-baseline-r5.md"
...
base.OWNER_INPUT = "ок это принимается"
...
def owner_requests() -> None:
    base.dump(base.EVIDENCE / "family-acceptance-decision-r5-request.json", {
        ...
        "decision_text": (
            ...
            "Dashboards family. Acceptance covers UI-DASH-001 in all six required states, "
            "the four responsive-Web anchors, all six visible isolated actions, Result Trust, "
        ...
        "target": {
            ...
            "artifact_id": "family.dash.shell-workspace.baseline-r5",
            "revision": 5,
...
def acceptance_request() -> None:
    ...
    base.dump(base.EVIDENCE / "resolved-owner-decisions.json", [{
        ...
        "status": "resolved",
        "summary": "The owner explicitly accepted the complete Dashboards r5 HTML review board.",
...
def transition_inputs() -> None:
    ...
    if family.get("result") != "passed" or family.get("owner_decision_ref") != base.rel(base.DECISION):
        raise ValueError("strict accepted dashboards family aggregate is not current")
    ...
    base.dump(base.EVIDENCE / "stage-transition-request.json", {
        ...
        "from_gate": "G4",
        "from_target": "family.dash.shell-workspace.baseline-r5",
        "from_revision": 5,
        "artifact": base.rel(base.FAMILY),
        "to_gate": "G4",
        "to_stage_id": base.NEXT_STAGE,
        "to_target": "family.rpt.shell-workspace.baseline-r5",
        ...
        "summary": "The owner accepted the complete Dashboards HTML review board; the strict family gate and adjacent-stage preflight pass.",
...
# G4 dashboards family accepted report

The owner accepted the complete hash-bound HTML review board for `UI-DASH-001`,
covering all six required states, all six isolated actions, and responsive-Web
...
def main() -> None:
    ...
    phase = parser.parse_args().phase
    {
        ...
        "transition-assembly-candidate": base.transition_assembly_candidate,
