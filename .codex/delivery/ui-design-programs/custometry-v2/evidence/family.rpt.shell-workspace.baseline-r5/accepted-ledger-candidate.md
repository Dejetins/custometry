...
| G4@family.pipe.shell-workspace.baseline-r5 | G4 | family.pipe.shell-workspace.baseline-r5 | .codex/agents/generated/custometry-ui-design-g0-v2/40-g4-12-family-pipe-shell-workspace-baseline-r5.md | pending | G3@CUSTOMETRY-UI-DESIGN-PROGRAM-V2-r5, G4@family.rpt.shell-workspace.baseline-r5 | .codex/delivery/evidence/custometry-ui-design-program-v2/family.pipe.shell-workspace.baseline-r5-report.md | .codex/delivery/ui-design-programs/custometry-v2/evidence/family.pipe.shell-workspace.baseline-r5/stage-transition.json | required | — | — |
