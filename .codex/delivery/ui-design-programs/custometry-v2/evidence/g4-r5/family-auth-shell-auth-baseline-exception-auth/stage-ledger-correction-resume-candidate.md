...
- proof_boundary: `current-contract stage evidence and adjacent-stage readiness; no production implementation, publication, deployment, mobile-specific design, or full WCAG conformance proof`
- blocker_policy: `needs_input_for_owner_questions_hard_block_only_for_unsafe_or_unrecoverable_conditions`
- decision_packet: `.codex/delivery/ui-design-programs/custometry-v2/evidence/g4-r5/family-auth-shell-auth-baseline-exception-auth/owner-review-decision-packet.json`
- resume_condition: `owner_accepts_or_requests_bounded_corrections_for_exact_finished_auth_family_r5_board`
- resume_evidence_ref: `.codex/delivery/ui-design-programs/custometry-v2/evidence/g4-r5/family-auth-shell-auth-baseline-exception-auth/owner-input-response-corrections-r5-01.json`
- resume_evidence_sha256: `21d3d669ba113cfdb221f7e4f0e6d71f1f443745d4e391aa3a44f811d14d43ae`
