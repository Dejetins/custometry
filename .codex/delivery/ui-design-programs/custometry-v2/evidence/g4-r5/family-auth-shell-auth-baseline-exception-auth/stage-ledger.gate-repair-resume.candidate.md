...
current_stage: G4@family.auth.shell-auth.baseline-exception-auth-r5
...
| G4@family.auth.shell-auth.baseline-exception-auth-r5 | G4 | family.auth.shell-auth.baseline-exception-auth-r5 | .codex/agents/generated/custometry-ui-design-g0-v2/40-g4-01-family-auth-shell-auth-baseline-exception-auth-r5.md | in_progress | G3@CUSTOMETRY-UI-DESIGN-PROGRAM-V2-r4 | .codex/delivery/ui-design-programs/custometry-v2/artifacts/g4-r5/family-auth-shell-auth-baseline-exception-auth/review-board.html | .codex/delivery/ui-design-programs/custometry-v2/evidence/g4-r5/family-auth-shell-auth-baseline-exception-auth/stage-transition.json | required | codex-root-g4-auth-r5-20260813T222203Z | 2026-08-13T22:22:03Z |
...
- proof_boundary: `current-contract stage evidence and adjacent-stage readiness; no production implementation, publication, deployment, mobile-specific design, or full WCAG conformance proof`
- blocker_policy: `needs_input_for_owner_questions_hard_block_only_for_unsafe_or_unrecoverable_conditions`
- decision_packet: `.codex/delivery/ui-design-programs/custometry-v2/evidence/g4-r5/family-auth-shell-auth-baseline-exception-auth/owner-review-decision-packet-correction-r5-02.json`
- resume_condition: `owner_accepts_or_requests_bounded_corrections_for_exact_finished_auth_family_r5_board`
- resume_evidence_ref: `.codex/delivery/ui-design-programs/custometry-v2/evidence/g4-r5/family-auth-shell-auth-baseline-exception-auth/owner-input-response-corrections-r5-02.json`
- resume_evidence_sha256: `bae9c2dce00a44f0070b56fa71bd63ec0cedb860dc018a3be8aec38fd140ba49`
