...
| G4@family.auth.shell-auth.baseline-exception-auth-r6 | G4 | family.auth.shell-auth.baseline-exception-auth-r6 | .codex/agents/generated/custometry-ui-design-g0-v2/40-g4-01-family-auth-shell-auth-baseline-exception-auth-r6.md | needs_input | G3@CUSTOMETRY-UI-DESIGN-PROGRAM-V2-r5 | .codex/delivery/ui-design-programs/custometry-v2/artifacts/g4-r6/family-auth-shell-auth-baseline-exception-auth/review-board.html | .codex/delivery/ui-design-programs/custometry-v2/evidence/g4-r6/family-auth-shell-auth-baseline-exception-auth/stage-transition-review-ready.json | required | codex-root-blueprint-rebind-r5-g4-20260819T140927Z | 2026-08-19T14:09:27Z |
