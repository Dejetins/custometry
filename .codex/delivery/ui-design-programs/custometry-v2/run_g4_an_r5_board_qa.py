#!/usr/bin/env python3
"""Verify that the G4 analytics research review bundle renders from file and bundle-root HTTP."""
...
ART = DIR / "artifacts/g4-r5/family-an-shell-workspace-baseline"
EVID = DIR / "evidence/family.an.shell-workspace.baseline-r5"
