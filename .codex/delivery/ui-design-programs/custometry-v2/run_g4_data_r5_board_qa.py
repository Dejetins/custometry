#!/usr/bin/env python3
"""Verify that the G4 data-connections review bundle renders from file and bundle-root HTTP."""
...
ART = DIR / "artifacts/g4-r5/family-data-shell-workspace-baseline"
EVID = DIR / "evidence/family.data.shell-workspace.baseline-r5"
