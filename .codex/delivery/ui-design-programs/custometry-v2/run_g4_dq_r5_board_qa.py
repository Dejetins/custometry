#!/usr/bin/env python3
"""Verify that the G4 data-quality review bundle renders from file and bundle-root HTTP."""
...
ART = DIR / "artifacts/g4-r5/family-dq-shell-workspace-baseline"
EVID = DIR / "evidence/family.dq.shell-workspace.baseline-r5"
