...
- [DIR-001. Shared platform and execution control](architecture/planning/directions/DIR-001/direction.md)
- [DIR-002. Data and semantic model](architecture/planning/directions/DIR-002/direction.md)
- [DIR-003. Analytics, segments and research](architecture/planning/directions/DIR-003/direction.md)
- [DIR-004. Analytical documents and result delivery](architecture/planning/directions/DIR-004/direction.md)
- [WS-002. First working analyst report](architecture/planning/directions/DIR-004/workstreams/WS-002.md)
- [WS-003. Configured metric workspace](architecture/planning/directions/DIR-004/workstreams/WS-003.md)
...
- [Metric workspace composition](architecture/ui/drafts/metric-workspace-v1/README.md)
- [Local composition verification](architecture/ui/drafts/metric-workspace-v1/design-qa.md)
