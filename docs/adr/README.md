...
| [ADR-0004](./0004-ui-delivery-governance.md) | superseded | Historical Linear/Penpot reset and G-program route; current work uses the target pilot and ordinary implementation tickets |
