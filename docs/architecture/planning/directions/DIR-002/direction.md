...
Develop source access, semantic/DQ preparation and immutable input publication
in dependency order with the real adapter and Web journey. Golden fixtures support
tests; they do not replace acceptance of real source-to-published-input behavior.
...
|---|---|---|---|---|---|
| DIR-002/DEP-01 | [DIR-001](../DIR-001/direction.md) `2.0.2` | Policy and common execution/fencing protocol | DIR-002 | Acceptance of the relevant scenario | Admission, access and attempt control. The owning milestone and its proof are selected at L2/L3. |
| DIR-002/DEP-02 | [DIR-006](../DIR-006/direction.md) `2.0.2` | Supported filesystem/storage environment and recovery procedure | DIR-002 | Acceptance of the relevant scenario | Durability and restore verification. The owning milestone and its proof are selected at L2/L3. |

**Outputs supplied:**

- [DIR-003](../DIR-003/direction.md) `2.0.2`: Versioned semantic datasets, metrics, relationships, readiness and marts.
- [DIR-004](../DIR-004/direction.md) `2.0.2`: Authorized manifests, data-as-of and lineage.
- [DIR-005](../DIR-005/direction.md) `2.0.2`: Source/mapping/DQ/Data Guide projections.
- [DIR-001](../DIR-001/direction.md) `2.0.2`: Published input generations and readiness events.
- [DIR-006](../DIR-006/direction.md) `2.0.2`: Immutable artifact/reference set and storage recovery ports.
