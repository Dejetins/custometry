...
|---|---|---|---|---|---|
| DIR-002/DEP-01 | [DIR-001](../DIR-001/direction.md) `1.2.0` | Policy and common execution/fencing protocol | DIR-002 | Acceptance of the relevant scenario | Admission, access and attempt control. The owning milestone and its proof are selected at L2/L3. |
| DIR-002/DEP-02 | [DIR-006](../DIR-006/direction.md) `1.2.0` | Supported filesystem/storage environment and recovery procedure | DIR-002 | Acceptance of the relevant scenario | Durability and restore verification. The owning milestone and its proof are selected at L2/L3. |

**Outputs supplied:**

- [DIR-003](../DIR-003/direction.md) `1.2.0`: Versioned semantic datasets, metrics, relationships, readiness and marts.
- [DIR-004](../DIR-004/direction.md) `1.2.0`: Authorized manifests, data-as-of and lineage.
- [DIR-005](../DIR-005/direction.md) `1.2.0`: Source/mapping/DQ/Data Guide projections.
- [DIR-001](../DIR-001/direction.md) `1.2.0`: Published input generations and readiness events.
- [DIR-006](../DIR-006/direction.md) `1.2.0`: Immutable artifact/reference set and storage recovery ports.
