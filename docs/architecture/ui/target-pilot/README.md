...
version 4 (editorial navigation update), combines those additions with the actual pilot source. On 2026-09-17
...
for local development in the [accepted WS-003 2.0.0 outline](../../planning/directions/DIR-004/workstreams/WS-003.md).
