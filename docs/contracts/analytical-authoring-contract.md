...
proof_boundary:
  label: target-contract-with-bounded-ms004-s01-foundation
...
The 1 MiB raw configuration bound is exposed by `parse_configuration`; future
v2 HTTP adapters must invoke the raw-body bound before parsing. Typed validation
