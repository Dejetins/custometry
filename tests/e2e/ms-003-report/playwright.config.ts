...
export default defineConfig({testDir:'.',testMatch:'report.spec.ts',workers:1,retries:0,forbidOnly:true,timeout:120000,reporter:'list',outputDir:root+'test-results/ms003',use:{baseURL:'http://127.0.0.1:41734',screenshot:'off',trace:'off'},webServer:[
