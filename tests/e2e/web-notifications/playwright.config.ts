...
export default defineConfig({
  testDir: ".",
  testMatch: "web-notifications.spec.ts",
  fullyParallel: false,
  forbidOnly: true,
  retries: 0,
  workers: 1,
  ...
  webServer: [
    {
      command: "bash -lc 'source scripts/activate-toolchain.sh && exec uv run --locked --package custometry-api python tests/e2e/web-notifications/real_api_fixture.py --port 8000'",
      cwd: repositoryRoot,
